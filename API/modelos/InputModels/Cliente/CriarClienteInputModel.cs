...
namespace API.modelos.InputModels
{
    ...
    public class CriarClienteInputModelValidator : AbstractValidator<CriarClienteInputModel>
    {
        public CriarClienteInputModelValidator()
        {
            RuleFor(x => x.NomeCompleto).NotEmpty().MaximumLength(255).WithMessage("Por favor, informe o nome completo do cliente!");            
        }
    }
}
